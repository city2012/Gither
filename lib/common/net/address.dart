...
class Address {
  ...
  //
  // "https://github.com/login/oauth/authorize?client_id=cd3206d0bb890be5b90a&state=app&scope=user,repo,gist,notifications,read:org,workflow&redirect_uri=gsygithubapp://authed"
  static getOAuthUrl() {
    return "https://github.com/login/oauth/authorize?client_id"
        "=${NetConfig.CLIENT_ID}&state=app&"
        "scope=user,repo,gist,notifications,read:org,workflow&"
        "redirect_uri=gither://authed";
    // return "https://git.toolsfdg.net/login/oauth/authorize?client_id"
    //     "=${NetConfig.CLIENT_ID}&state=app&"
    //     "scope=user,repo,gist,notifications,read:org,workflow&"
    //     "redirect_uri=gither://authed";
  }
