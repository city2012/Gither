...
class _GSYTabBarState extends State<GSYTabBarWidget>
  ...
  _navigationPageChanged(index) {
    ...
    _index = index;
    _tabController!.animateTo(index, duration: Duration(milliseconds: 300), curve: Curves.slowMiddle);
  ...
  _navigationTapClick(index) {
    ...
    // _pageController.animateTo(MediaQuery.of(context).size.width * index, duration: Duration(milliseconds: 500), curve: Curves.easeInOutCubicEmphasized);
    _pageController.animateTo(MediaQuery.of(context).size.width * index, duration: Duration(milliseconds: 300), curve: Curves.fastOutSlowIn);
